...
""" 
Used Chat GPT to check my work and fix any errors i had. 
"""
...
class CarController():
    ...
    def calculate(self, doCalc=True):
        ...
        g = 9.81
        force = self.model.m1 * g
        self.model.mink1 = force / 0.1524  # 3 inches max compression
        self.model.maxk1 = force / 0.0762  # 6 inches min compression
        self.model.mink2 = force / 0.0381  # 0.75 inches max compression
        self.model.maxk2 = force / 0.01905 # 1.5 inches min compression
